...
<html>
    ...
    <body>
        <aside class="w-64 fixed top-0 left-0" aria-label="Sidebar" style="min-width: 250px">
            <div class="px-5 py-4 overflow-y-auto rounded bg-gray-50 min-h-screen">
                <div class="mb-40 mt-10 flex items-center justify-center flex-col">
                ...
                <ul class="space-y-2 w-full mb-80">
                    <li>
