...
<html>
    <head>
        ...
        <%
            StatusCalendar status = (StatusCalendar) request.getAttribute("status");
        %>
    </head>
        ...
        <div class="flex">
            ...
            <div class="w-full px-10 py-5">
                <div class="mb-6">
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li class="inline-flex items-center text-xl">
                                <a href="/admin/status" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500" id="status-show-name"><%=status.getName()%></span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="flex justify-center items-center" style="height: 80vh">
                    <form style="width: 500px" id="form-status-edit">
                        ...
                        <input name="id" value="<%=status.getId()%>" type="hidden"/>
                        <div class="mb-6">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Name category</label>
                            <input required type="text" id="name" name="name" value="<%=status.getName()%>"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                ...
                if($("input[name='name']").val()===""){
                    ...
                    $.ajax({
                        ...
                        if (data?.detailMessage) {
                            ...
                            $("#status-show-name").text(data?.name)
